...
import { deleteContact } from "../../redux/reducers/auth";
    ...
    <div key={c.id} className={s.contact}>
      ...
      <div className={s.buttons}>
        <div className={s.buttonWrap}>
          <button onClick={() => openModal(c)} className={s.button}>
            Edit
          </button>
        </div>
        <div className={s.buttonWrap}>
          <button
            onClick={() => deleteContactButton(id, user)}
            className={s.button}
          >
            Delete
          </button>
  ...
  return (
    <div className={s.contacts}>
      ...
      <ChangeModal
        ...
        contact={contact}
        onSubmit={(cnt) => changeContactButton(cnt)}
      />
    </div>
  );
}
